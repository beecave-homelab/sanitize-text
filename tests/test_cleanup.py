...
def test_remove_unknown_placeholders() -> None:
    ...
    assert remove_unknown_placeholders("Email EMAIL-123 and URL-456") == "Email EMAIL-123 and URL-456"
...
def test_cleanup_output_pipeline() -> None:
    ...
    input_text = "Hello <UNKNOWN-1> world\nLine 2\nLine 2\n[Very long base64 string: ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789]"
...
def test_collapse_long_gibberish_in_brackets() -> None:
    ...
    long_text = "[ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789]"
    result = collapse_long_gibberish_in_brackets(long_text)
    assert len(result) < len(long_text)
    assert "…" in result
    
    # Test long sequences in parentheses
    long_paren = "(ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789)"
