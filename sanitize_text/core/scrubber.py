...
try:  # pragma: no cover - optional dependency
    ...
    SpacyEntityDetector = None  # type: ignore[assignment]
...
def get_available_detectors(locale: Optional[str] = None) -> Dict[str, str]:
    ...
    if SpacyEntityDetector is not None:
...
def setup_scrubber(
    ...
    normalized_selection: Optional[List[str]] = None
    ...
    if SpacyEntityDetector is not None:
        locale_factories.setdefault('nl_NL', {})['spacy_entities'] = (
            lambda: SpacyEntityDetector(model='nl_core_news_sm', name='spacy_nl')
        )
        locale_factories.setdefault('en_US', {})['spacy_entities'] = (
            lambda: SpacyEntityDetector(model='en_core_web_sm', name='spacy_en')
        )
