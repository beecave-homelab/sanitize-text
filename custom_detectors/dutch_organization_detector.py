...
from .dutch_filth import OrganizationFilth

@register_detector
class DutchOrganizationDetector(Detector):
    name = 'dutch_organization_detector'
    ...
    def _load_json_entities(self):
        try:
            with open('nl_entities/organizations.json', 'r') as f:
            ...
            click.echo(f"Warning: Could not load JSON entity file organizations.json: {str(e)}", err=True)
