...
from .dutch_filth import LocationFilth

@register_detector
class DutchLocationDetector(Detector):
    name = 'dutch_location_detector'
    ...
    def _load_json_entities(self):
        try:
            with open('nl_entities/cities.json', 'r') as f:
            ...
            click.echo(f"Warning: Could not load JSON entity file cities.json: {str(e)}", err=True)
